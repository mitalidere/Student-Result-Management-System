...
echo"";
if($studentname=="" || $enrollmentno=="" || $scheme=="" || $email=="" || $phoneno=="" || $gender=="")
{
echo'<script>alert("Please fill all the details")</script>';	
}
else if($studentname!="" && $enrollmentno!="" && $scheme!="" && $email!="" && $phoneno!="" && $gender!="")
{
$sql="insert into result1(studentname,enrollmentno,scheme,email,phoneno,gender)values('$studentname','$enrollmentno','$scheme','$email','$phoneno','$gender')";
...
Enrollment no.: <input class="a" type="text" id="t2" name="enrollmentno"><br><br>
Scheme: <input class="a" type="text" id="t3" name="scheme"><br><br>
